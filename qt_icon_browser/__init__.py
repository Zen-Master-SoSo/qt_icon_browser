...
from PyQt5.QtWidgets import 	QApplication, QMainWindow, QShortcut, QStyle, \
...
QT_STANDARD_PIXMAPS = [
	('QStyle.SP_TitleBarMinButton', QStyle.SP_TitleBarMinButton, 'Minimize button on title bars (e.g., in QMdiSubWindow).'),
	('QStyle.SP_TitleBarMenuButton', QStyle.SP_TitleBarMenuButton, 'Menu button on a title bar.'),
	('QStyle.SP_TitleBarMaxButton', QStyle.SP_TitleBarMaxButton, 'Maximize button on title bars.'),
	('QStyle.SP_TitleBarCloseButton', QStyle.SP_TitleBarCloseButton, 'Close button on title bars.'),
	('QStyle.SP_TitleBarNormalButton', QStyle.SP_TitleBarNormalButton, 'Normal (restore) button on title bars.'),
	('QStyle.SP_TitleBarShadeButton', QStyle.SP_TitleBarShadeButton, 'Shade button on title bars.'),
	('QStyle.SP_TitleBarUnshadeButton', QStyle.SP_TitleBarUnshadeButton, 'Unshade button on title bars.'),
	('QStyle.SP_TitleBarContextHelpButton', QStyle.SP_TitleBarContextHelpButton, 'The Context help button on title bars.'),
	('QStyle.SP_MessageBoxInformation', QStyle.SP_MessageBoxInformation, 'The "information" icon.'),
	('QStyle.SP_MessageBoxWarning', QStyle.SP_MessageBoxWarning, 'The "warning" icon.'),
	('QStyle.SP_MessageBoxCritical', QStyle.SP_MessageBoxCritical, 'The "critical" icon.'),
	('QStyle.SP_MessageBoxQuestion', QStyle.SP_MessageBoxQuestion, 'The "question" icon.'),
	('QStyle.SP_DesktopIcon', QStyle.SP_DesktopIcon, 'The "desktop" icon.'),
	('QStyle.SP_TrashIcon', QStyle.SP_TrashIcon, 'The "trash" icon.'),
	('QStyle.SP_ComputerIcon', QStyle.SP_ComputerIcon, 'The "My computer" icon.'),
	('QStyle.SP_DriveFDIcon', QStyle.SP_DriveFDIcon, 'The floppy icon.'),
	('QStyle.SP_DriveHDIcon', QStyle.SP_DriveHDIcon, 'The harddrive icon.'),
	('QStyle.SP_DriveCDIcon', QStyle.SP_DriveCDIcon, 'The CD icon.'),
	('QStyle.SP_DriveDVDIcon', QStyle.SP_DriveDVDIcon, 'The DVD icon.'),
	('QStyle.SP_DriveNetIcon', QStyle.SP_DriveNetIcon, 'The network icon.'),
	('QStyle.SP_DirHomeIcon', QStyle.SP_DirHomeIcon, 'The home directory icon.'),
	('QStyle.SP_DirOpenIcon', QStyle.SP_DirOpenIcon, 'The open directory icon.'),
	('QStyle.SP_DirClosedIcon', QStyle.SP_DirClosedIcon, 'The closed directory icon.'),
	('QStyle.SP_DirIcon', QStyle.SP_DirIcon, 'The directory icon.'),
	('QStyle.SP_DirLinkIcon', QStyle.SP_DirLinkIcon, 'The link to directory icon.'),
	('QStyle.SP_DirLinkOpenIcon', QStyle.SP_DirLinkOpenIcon, 'The link to open directory icon.'),
	('QStyle.SP_FileIcon', QStyle.SP_FileIcon, 'The file icon.'),
	('QStyle.SP_FileLinkIcon', QStyle.SP_FileLinkIcon, 'The link to file icon.'),
	('QStyle.SP_FileDialogStart', QStyle.SP_FileDialogStart, 'The "start" icon in a file dialog.'),
	('QStyle.SP_FileDialogEnd', QStyle.SP_FileDialogEnd, 'The "end" icon in a file dialog.'),
	('QStyle.SP_FileDialogToParent', QStyle.SP_FileDialogToParent, 'The "parent directory" icon in a file dialog.'),
	('QStyle.SP_FileDialogNewFolder', QStyle.SP_FileDialogNewFolder, 'The "create new folder" icon in a file dialog.'),
	('QStyle.SP_FileDialogDetailedView', QStyle.SP_FileDialogDetailedView, 'The detailed view icon in a file dialog.'),
	('QStyle.SP_FileDialogInfoView', QStyle.SP_FileDialogInfoView, 'The file info icon in a file dialog.'),
	('QStyle.SP_FileDialogContentsView', QStyle.SP_FileDialogContentsView, 'The contents view icon in a file dialog.'),
	('QStyle.SP_FileDialogListView', QStyle.SP_FileDialogListView, 'The list view icon in a file dialog.'),
	('QStyle.SP_FileDialogBack', QStyle.SP_FileDialogBack, 'The back arrow in a file dialog.'),
	('QStyle.SP_DockWidgetCloseButton', QStyle.SP_DockWidgetCloseButton, 'Close button on dock windows (see also QDockWidget).'),
	('QStyle.SP_ToolBarHorizontalExtensionButton', QStyle.SP_ToolBarHorizontalExtensionButton, 'Extension button for horizontal toolbars.'),
	('QStyle.SP_ToolBarVerticalExtensionButton', QStyle.SP_ToolBarVerticalExtensionButton, 'Extension button for vertical toolbars.'),
	('QStyle.SP_DialogOkButton', QStyle.SP_DialogOkButton, 'Icon for a standard OK button in a QDialogButtonBox.'),
	('QStyle.SP_DialogCancelButton', QStyle.SP_DialogCancelButton, 'Icon for a standard Cancel button in a QDialogButtonBox.'),
	('QStyle.SP_DialogHelpButton', QStyle.SP_DialogHelpButton, 'Icon for a standard Help button in a QDialogButtonBox.'),
	('QStyle.SP_DialogOpenButton', QStyle.SP_DialogOpenButton, 'Icon for a standard Open button in a QDialogButtonBox.'),
	('QStyle.SP_DialogSaveButton', QStyle.SP_DialogSaveButton, 'Icon for a standard Save button in a QDialogButtonBox.'),
	('QStyle.SP_DialogCloseButton', QStyle.SP_DialogCloseButton, 'Icon for a standard Close button in a QDialogButtonBox.'),
	('QStyle.SP_DialogApplyButton', QStyle.SP_DialogApplyButton, 'Icon for a standard Apply button in a QDialogButtonBox.'),
	('QStyle.SP_DialogResetButton', QStyle.SP_DialogResetButton, 'Icon for a standard Reset button in a QDialogButtonBox.'),
	('QStyle.SP_DialogDiscardButton', QStyle.SP_DialogDiscardButton, 'Icon for a standard Discard button in a QDialogButtonBox.'),
	('QStyle.SP_DialogYesButton', QStyle.SP_DialogYesButton, 'Icon for a standard Yes button in a QDialogButtonBox.'),
	('QStyle.SP_DialogNoButton', QStyle.SP_DialogNoButton, 'Icon for a standard No button in a QDialogButtonBox.'),
	('QStyle.SP_ArrowUp', QStyle.SP_ArrowUp, 'Icon arrow pointing up.'),
	('QStyle.SP_ArrowDown', QStyle.SP_ArrowDown, 'Icon arrow pointing down.'),
	('QStyle.SP_ArrowLeft', QStyle.SP_ArrowLeft, 'Icon arrow pointing left.'),
	('QStyle.SP_ArrowRight', QStyle.SP_ArrowRight, 'Icon arrow pointing right.'),
	('QStyle.SP_ArrowBack', QStyle.SP_ArrowBack, 'Equivalent to SP_ArrowLeft when the current layout direction is Qt::LeftToRight, otherwise SP_ArrowRight.'),
	('QStyle.SP_ArrowForward', QStyle.SP_ArrowForward, 'Equivalent to SP_ArrowRight when the current layout direction is Qt::LeftToRight, otherwise SP_ArrowLeft.'),
	('QStyle.SP_CommandLink', QStyle.SP_CommandLink, 'Icon used to indicate a Vista style command link glyph.'),
	('QStyle.SP_VistaShield', QStyle.SP_VistaShield, 'Icon used to indicate UAC prompts on Windows Vista. This will return a null pixmap or icon on all other platforms.'),
	('QStyle.SP_BrowserReload', QStyle.SP_BrowserReload, 'Icon indicating that the current page should be reloaded.'),
	('QStyle.SP_BrowserStop', QStyle.SP_BrowserStop, 'Icon indicating that the page loading should stop.'),
	('QStyle.SP_MediaPlay', QStyle.SP_MediaPlay, 'Icon indicating that media should begin playback.'),
	('QStyle.SP_MediaStop', QStyle.SP_MediaStop, 'Icon indicating that media should stop playback.'),
	('QStyle.SP_MediaPause', QStyle.SP_MediaPause, 'Icon indicating that media should pause playback.'),
	('QStyle.SP_MediaSkipForward', QStyle.SP_MediaSkipForward, 'Icon indicating that media should skip forward.'),
	('QStyle.SP_MediaSkipBackward', QStyle.SP_MediaSkipBackward, 'Icon indicating that media should skip backward.'),
...
DIR = [
	...
	('Application', STANDARD_APPLICATION_ICONS),
	('Category', STANDARD_CATEGORY_ICONS),
	('Device', STANDARD_DEVICE_ICONS),
	('Emblem', STANDARD_EMBLEM_ICONS),
	('Emotion', STANDARD_EMOTION_ICONS),
	('MIME Type', STANDARD_MIME_TYPE_ICONS),
	('Place', STANDARD_PLACE_ICONS),
	('Status', STANDARD_STATUS_ICONS)
]
...
class _PreviewFrame(QFrame):
	...
	def __init__(self, parent, elems):
		...
		self.buttons = []
		self.create_buttons(elems)
		self.grid = QGridLayout()
		lo = QVBoxLayout()
		lo.addLayout(self.grid)
		lo.addStretch(10)
		self.setLayout(lo)


	def resizeEvent(self, event):
		cell_width = ICON_SIZE + 16
		columns = event.size().width() // cell_width
...
class IconFrame(_PreviewFrame):

	def create_buttons(self, elems):
		for icon in elems:
			btn = QPushButton('', self)
			btn.setIcon(QIcon.fromTheme(icon[0]))
			btn.setIconSize(QSize(ICON_SIZE, ICON_SIZE))
			btn.setToolTip(f'{icon[0]}: {icon[1]}')
			btn.clicked.connect(partial(copy_code, f'QIcon.fromTheme("{icon[0]}")'))
			self.buttons.append(btn)


class PixmapFrame(_PreviewFrame):

	def create_buttons(self, elems):
		for pixmap in elems:
			btn = QPushButton('', self)
			btn.setIcon(QApplication.style().standardIcon(pixmap[1]))
			btn.setIconSize(QSize(ICON_SIZE, ICON_SIZE))
			btn.setToolTip(f'{pixmap[0]}: {pixmap[2]}')
			btn.clicked.connect(partial(copy_code, f'QApplication.style().standardIcon({pixmap[0]})'))
			self.buttons.append(btn)
...
#  end qt_icon_browser/__main__.py
